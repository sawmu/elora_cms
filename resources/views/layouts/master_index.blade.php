                            ...
                            <div class="col-xl-8 col-lg-6 col-12">
                                <div class="wpo-static-hero-inner">
                                    ...
                                    <div data-swiper-parallax="300" class="slide-title">
                                        <h2>Edina <span>&</span> Mu Ka Hbaw</h2>
                                    </div>
                                    <div data-swiper-parallax="400" class="slide-text">
                                        <p>We Are Getting Married Dec 22, 2022</p>
                                    </div>
            ...
            <div class="static-hero-right">
                <div class="static-hero-img">
                    <div class="static-hero-img-inner">
                        <img src="{{asset('frontend/assets/images/slider/s1.png')}}" alt="E&M">
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="wpo-team-item">
                                <div class="wpo-team-img">
                                    <div class="wpo-team-img-inner">
                                        <img src="{{asset('frontend/assets/images/team/img-1.jpg')}}" alt="E&M">
                                    </div>
                        ...
                        <div class="col col-lg-4 col-md-6 col-sm-12 col-12">
                            <div class="wpo-team-item">
                                <div class="wpo-team-img">
                                    <div class="wpo-team-img-inner">
                                        <img src="{{asset('frontend/assets/images/team/img-2.jpg')}}" alt="E&M">
                                    </div>
                                    <div class="shape-1"><img src="{{asset('frontend/assets/images/team/shape1.jpg')}}" alt="E&M"></div>
                                    <div class="shape-2"><img src="{{asset('frontend/assets/images/team/shape2.jpg')}}" alt="E&M"></div>
                                </div>
                        ...
                        <div class="col col-lg-4 col-md-6 col-sm-12 col-12">
                            <div class="wpo-team-item">
                                <div class="wpo-team-img">
                                    <div class="wpo-team-img-inner">
                                        <img src="{{asset('frontend/assets/images/team/img-3.jpg')}}" alt="E&M">
                                    </div>
                                    <div class="shape-1"><img src="{{asset('frontend/assets/images/team/shape1.jpg')}}" alt="E&M"></div>
                                    <div class="shape-2"><img src="{{asset('frontend/assets/images/team/shape2.jpg')}}" alt="E&M"></div>
                                </div>
